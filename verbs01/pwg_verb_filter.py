...
def mark_entries_verb(entries,exclusions):
 """ pwg verbs: <ls>DHĀTUP """
 ...
 for entry in entries:
  ...
  patterns = [u'<ls>DHĀTUP.','[dD]enom[.] von','Sautra',u'<div n="p">— {#([a-zA-Z]+)#}']
  codes = [None,None,None,None]
  pattern_codes = ['D','N','S','U']
  lex=False
...
if __name__=="__main__": 
 ...
 filein1 = sys.argv[2] # pwg_verb_exclude.txt

 fileout = sys.argv[3] # 
 entries = init_entries(filein)
 exclusions = init_exclusions(filein1)
 mark_entries_verb(entries,exclusions)
