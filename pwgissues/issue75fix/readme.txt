...
readme_mw.txt ~100 additional links  temp_mw_1.txt
 Revise basicadjust (csl-websanlexicon repo)
...
git pull
git add .
git commit -m "issue75fix  splitting 'Ramayana Bombay' refs
...
git pull
git add .
git commit -m "issue75fix 'Ramayana Bombay' link splitting
Ref: https://github.com/sanskrit-lexicon/pwg/issues/160"
git push
