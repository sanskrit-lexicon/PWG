...
10-08-2025 begun ejf
fix references to Rājataraṅgiṇī, Troyer, 1840

sanskrit-lexicon-scans/

Ref: https://github.com/sanskrit-lexicon/PWG/tree/master/pwgissues/issue135fix
...
--------------------------------------
link target sample: https://sanskrit-lexicon-scans.github.io/rajatar/app1?N,N
...
readme_pwg.txt 4027 links added.
  ~500 unlinked refs to taranga 7 or 8.
     csl-websanlexicon, csl-apidev modified
  Classification of 60 other unlinked cases.
  
readme_pw.txt  78 additional links
     csl-websanlexicon, csl-apidev modified similarly
readme_pwkvn.txt  no changes.
     csl-websanlexicon, csl-apidev modified similarly
readme_sch.txt  10 additional links (temp_sch_1a.txt)
  2 new headwords
     csl-websanlexicon, csl-apidev modified similarly
readme_mw.txt Several changes. (temp_mw_1.txt)
     csl-websanlexicon, csl-apidev modified similarly
...
git pull
git add .
git commit -m "issue135fix  splitting 'RĀJAT.' refs
...
-----------------------------------------------------
# sync issue135fix to github.
cd /c/xampp/htdocs/sanskrit-lexicon/PWG/pwgissues/issue135fix
git pull
git add .
git commit -m "issue135fix 'RĀJAT.' link splitting
Ref: https://github.com/sanskrit-lexicon/pwg/issues/160"
git push
