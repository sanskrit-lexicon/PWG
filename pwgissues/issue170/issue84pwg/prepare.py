# coding=utf-8
""" prepare.py  revised. so oldparms (parts[4]) absent in input/output
"""
...
class REPL:
 def __init__(self,line):
  ...
  #self.oldparms = 'oldparms'  # 
  self.newparms = parts[4]  # correction to oldparms
