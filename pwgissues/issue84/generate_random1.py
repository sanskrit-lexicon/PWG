# coding=utf-8
""" generate_random.py for shatapathabr
"""
...
def set_pagerec_key(pagerecs,dictcode):
 for rec in pagerecs:
  rec.keymin = (rec.kand,rec.adhy,rec.brahm,rec.fromv)
  rec.keymax = (rec.kand,rec.adhy,rec.brahm,rec.tov)
