# coding=utf-8
""" generate_random.py for generate_random.py for sahityadarpana (pwg, pw, pwkvn, sch)
"""
...
def get_dict_regex(dictcode):
 d = {
  ...
  'pwg2':r'<ls>SĀH. D. ([0-9]+),([0-9]+)',   # ipage,linenum

  'pw1':r'<ls>SĀH. D. ([0-9]+)[^0-9,]',  # verse
  'pw2':r'<ls>SĀH. D. ([0-9]+),([0-9]+)',   # ipage,linenum

  'pwkvn1':r'<ls>SĀH. D. ([0-9]+)[^0-9,]',  # verse
  'pwkvn2':r'<ls>SĀH. D. ([0-9]+),([0-9]+)',   # ipage,linenum

  'sch1':r'<ls>Sāh. D. ([0-9]+)[^0-9,]',  # verse
  'sch2':r'<ls>Sāh. D. ([0-9]+),([0-9]+)',   # ipage,linenum

  'mw1':r'<ls>Sāh. ([0-9]+)[^0-9,]',  # verse
  'mw2':r'<ls>Sāh. ([0-9]+), *([0-9]+)',   # ipage,linenum
