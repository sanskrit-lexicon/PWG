...
def get_standard_regexes():
 regex1raw = r'<ls>KATHĀS\. ([0-9]+), ([0-9]+)\.?</ls>'
 regex2raw = r'<ls n="KATHĀS\. ([0-9]+),">([0-9])+\.?</ls>'
 regex3raw = r'<ls n="KATHĀS\.">([0-9]+), ([0-9])+\.?</ls>'
 regex4raw =  r'<ls>KATHĀS\.</ls>'
 regex5raw = r'<ls>KATHĀS\. ([0-9]+), ([0-9]+)\. fgg?\.</ls>'
 regex6raw = r'<ls n="KATHĀS\. ([0-9]+),">([0-9])+\. fgg?\.</ls>'
 regex7raw = r'<ls n="KATHĀS\.">([0-9]+), ([0-9])+\. fgg?\.</ls>'
 regex1 = re.compile(regex1raw)
 regex2 = re.compile(regex2raw)
...
def get_links4(entries):
 ...
 regex1 = re.compile(regex1raw)
 regex2 = re.compile(regex2raw)
 regex0raw = r'<ls.*?</ls>' # ALL ls - not only KATHĀS
