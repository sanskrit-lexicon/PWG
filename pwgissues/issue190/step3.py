...
with open('temp_pwg2.txt', 'r', encoding='utf-8') as f:
    text = f.read()
...
with open('temp_pwg3.txt', 'w', encoding='utf-8') as f:
    f.write(result)

print(f"Pass 2: temp_pwg3.txt written, {count} replacements made")
