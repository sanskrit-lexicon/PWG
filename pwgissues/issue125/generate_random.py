# coding=utf-8
""" generate_random.py for shakuntala
"""
...
def get_dict_regex(dictcode):
 d = {
  'pwg1':r'<ls>ŚĀK. ([0-9]+)[^0-9,]',  # verse
  'pwg2':r'<ls>ŚĀK. ([0-9]+),([0-9]+)',   # ipage,linenum

  'pw1':r'<ls>ŚĀK. ([0-9]+)[^0-9,]',  # verse
  'pw2':r'<ls>ŚĀK. ([0-9]+),([0-9]+)',   # ipage,linenum

  'pwkvn1':r'<ls>ŚĀK. ([0-9]+)[^0-9,]',  # verse
  'pwkvn2':r'<ls>ŚĀK. ([0-9]+),([0-9]+)',   # ipage,linenum

  'sch1':r'<ls>Śāk. ([0-9]+)[^0-9,]',  # verse
  'sch2':r'<ls>Śāk. ([0-9]+),([0-9]+)',   # ipage,linenum

  'mw1':r'<ls>Śak. ([0-9]+)[^0-9,]',  # verse
  'mw2':r'<ls>Śak. ([0-9]+), *([0-9]+)',   # ipage,linenum
