...
def get_links2_debug(entry,iregex,m,v):
 vdbgs =  [(1,144), (1,180), (1,4116),
           (2,317),
           (3,628), (3,6028), (3,12484),
           (4,348),
           (5,195),
           (6,162), (6,165),(6,183),
           (7,2498),
           (8,787),
           (10,158), (10,181),
           (11,286),(11,576),(11,747),
             (11,331),  # twice
           (12,179),(12,212),(12,226),
           (12,917),(12,921),(12,1321),(12,1825),
           #problems with adhyaya also
           (13,63), (13,1659),(40,53),(51,5),(70,95),
           (70,97),(87,11),(87,18),(125,210),
 ...
 if v in vdbgs:
  ...
  out = '(%s,%s) %s %s' %(v1,v2,meta,m.group(0))
  print(out)
  ...
  for iregex,regex in enumerate(regexes):
   for m in re.finditer(regex,text):
    ...
    if v not in d:
     d[v] = 0
    d[v] = d[v] + 1
    get_links2_debug(entry,iregex,m,v)
 keys = sorted(d.keys())
 ntot = 0
 for v in keys:
  n = d[v]
 ...
 for text in texts:
  for iregex,regex in enumerate(regexes):
   for m in re.finditer(regex,text):
    ...
    if True: # dbg
     #if v == (2,0):
      print('chk',iregex, m.group(0), m.group(1), m.group(2))
 exit(1)
