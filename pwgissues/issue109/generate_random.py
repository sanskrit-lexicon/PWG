...
def get_dict_regex(dictcode):
 d = {
  'pwg1':r'<ls>RAGH. ed. Calc. ([0-9]+),([0-9]+)',
  'pwg2':r'<ls>RAGH. \(ed. Calc.\) ([0-9]+),([0-9]+)',
  'pwg3':r'<ls>RAGH. \(Calc.\) ([0-9]+),([0-9]+)',

  'pw':r'<ls>RAGH. ed. Calc. ([0-9]+),([0-9]+)',
  'pwkvn':r'<ls>RAGH. ed. Calc. ([0-9]+),([0-9]+)',

  'sch':r'<ls>Ragh. ed. Calc. ([0-9]+),([0-9]+)',

  'mw':r'<ls>Ragh. \(C\) ([vix]+), *([0-9]+)',   # 
