...
=================================================
app2  ipage,line-number
=================================================
/c/xampp/htdocs/sanskrit-lexicon-scans/hitopadesha
local url:
localhost/sanskrit-lexicon-scans/hitopadesha/app2/N,N


Github url:
https://sanskrit-lexicon-scans.github.io/hitopadesha/app2/?N,N

https://sanskrit-lexicon-scans.github.io/hitopadesha/
shows README.md  (with markdown converted to html)

----------------
# app2 is similar to that of /pantakokse/app2
cd /c/xampp/htdocs/sanskrit-lexicon-scans/hitopadesha
cp -r ../pantakose/app2 .

# get the index

cp /c/xampp/htdocs/sanskrit-lexicon/PWG/pwgissues/issue152/index.txt app2/pywork/
# get the program to convert index.txt to index.js
cp /c/xampp/htdocs/sanskrit-lexicon/PWG/pwgissues/issue152/make_js_index.py app2/pywork/
...
cd /c/xampp/htdocs/sanskrit-lexicon-scans/hitopadesha/app2
