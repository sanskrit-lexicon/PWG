# coding=utf-8
""" generate_random.py for pantankose
"""
...
def get_dict_regex(dictcode):
 d = {
  'pwg1':r'<ls>PAÑCAT. ([0-9]+),([0-9]+)',   # 
  'pwg2':r'<ls>PAÑCAT. ([VI]+),([0-9]+)',   # 
  'pwg3':r'<ls>PAÑCAT. (Pr\.) ([0-9]+)',   # 

  'pw1':r'<ls>PAÑCAT. ([0-9]+),([0-9]+)',   # 
  'pw2':r'<ls>PAÑCAT. ([VI]+),([0-9]+)',   # 
  'pw3':r'<ls>PAÑCAT. (Pr\.) ([0-9]+)',   # 

  'pwkvn1':r'<ls>PAÑCAT. ([0-9]+),([0-9]+)',   # 
  'pwkvn2':r'<ls>PAÑCAT. ([VI]+),([0-9]+)',   # 
  'pwkvn3':r'<ls>PAÑCAT. (Pr\.) ([0-9]+)',   # 

  'sch1':r'<ls>Pañcat. ([0-9]+),([0-9]+)',   # 
  'sch2':r'<ls>Pañcat. ([vi]+),([0-9]+)',   # 
  'sch3':r'<ls>Pañcat. (Pr\.) ([0-9]+)',   # 

  'mw1':r'<ls>Pañcat. ([0-9]+), *([0-9]+)',   # 
  'mw2':r'<ls>Pañcat. ([vi]+), *([0-9]+)',   # 
  'mw3':r'<ls>Pañcat. (Pr\.) ([0-9]+)',   # 
