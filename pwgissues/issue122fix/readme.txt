...
09-14-2025 begun ejf
fix references to 05436 MĀRK. P. = MĀRKĀṆḌEYAPURĀṆA

sanskrit-lexicon-scans/

Ref: https://github.com/sanskrit-lexicon/PWG/tree/master/pwgissues/issue122fix
...
readme_pw.txt  10 new links added.  (temp_pw_1.txt)
  
readme_pwkvn.txt  no changes.  
 
readme_sch.txt  4 links added.  (temp_sch_2.txt)

readme_mw.txt  no new links; 1 change (temp_mw_1.txt)
...
git pull
git add .
git commit -m "issue122fix  splitting 'MĀRK. P.' refs
...
-----------------------------------------------------
# sync issue122fix to github.
cd /c/xampp/htdocs/sanskrit-lexicon/PWG/pwgissues/issue122fix
git pull
git add .
git commit -m "issue122fix 'MĀRK. P.' link splitting
Ref: https://github.com/sanskrit-lexicon/pwg/issues/160"
git push
