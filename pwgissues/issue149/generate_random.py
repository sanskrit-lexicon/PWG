...
def get_dict_regex(dictcode):
 d = {
  # 1-parameter
  'pwg1':r'<ls>MĀLAV. ([0-9]+)[^0-9,]',
  'pw1':r'<ls>MĀLAV. ([0-9]+)[^0-9,]',
  'pwkvn1':r'<ls>MĀLAV. ([0-9]+)[^0-9,]',
  'sch1':r'<ls>Mālav. ([0-9]+)[^0-9,]',
  'mw1':r'<ls>Mālav. ([0-9]+)[^0-9,]',

  # 2-parameters
  'pwg2':r'<ls>MĀLAV. ([0-9]+),([0-9]+)',
  'pw2':r'<ls>MĀLAV. ([0-9]+),([0-9]+)',
  'pwkvn2':r'<ls>MĀLAV. ([0-9]+),([0-9]+)',
  'sch2':r'<ls>Mālav. ([0-9]+),([0-9]+)',
