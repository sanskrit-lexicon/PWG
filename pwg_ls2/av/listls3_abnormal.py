...
def regexdata_extra1(ls,tmp):
 ...
 if (ls == 'AV.'):
  return [
   ('<ls>AV. ANUKR\.</ls>','<ls>AV. ANUKR.</ls>'),
   ('<ls>AV. ANUKR\. ([0-9]+), ([0-9]+[.]?)</ls>','<ls>AV. ANUKR. #, #.</ls>'),

   ('<ls>AV. PRĀT\.</ls>','<ls>AV. PRĀT\.</ls>'),
   ('<ls>AV. PRĀT\. ([0-9]+), ([0-9]+[.]?)</ls>','<ls>AV. PRĀT. #, #.</ls>'),

   ('<ls>AV. PARIŚ\.</ls>','<ls>AV. PARIŚ.</ls>'),
   ('<ls>AV. PARIŚ\. ([0-9]+[.]?)</ls>','<ls>AV. PARIŚ. #.</ls>'),
   ('<ls>AV. PARIŚ\. ([0-9]+), ([0-9]+[.]?)</ls>','<ls>AV. PARIŚ. #, #.</ls>'),
   ('<ls>AV. PARIŚ\. ([0-9]+), ([0-9]+), ([0-9]+[.]?)</ls>','<ls>AV. PARIŚ. #, #, #.</ls>'),
   ('<ls>AV. PAR\.</ls>','<ls>AV. PAR.</ls>'),
  ]
 return []
