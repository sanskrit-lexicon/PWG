...
def ls12parm(line,abbrev,tipd):
 abbrevregex = abbrev.replace('.','[.]')
 parmregex = r' ([0-9]+), ([0-9]+), ([0-9]+)[.] ([0-9]+), ([0-9]+), ([0-9]+)[.] ([0-9]+), ([0-9]+), ([0-9]+)[.] ([0-9]+), ([0-9]+), ([0-9]+)([.]?)'
...
def init_changes(lines,tipd,abbrev):
 ...
 for iline,line in enumerate(lines):
  ...
  if metaline == None:
   continue
  newline = ls12parm(line,abbrev,tipd)
  if newline == line:
   continue
  # generate a change
